...
public enum CardType implements Matchable {
	INSTANCE("INST", "instance"),
	;
	String code;
	String value;

	CardType(String code, String value) {
		this.code = code;
		this.value = value;
	}
	...
	public static CardType getType(String code) {
	...
	public static List<CardType> getAllTypes() {
